    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          {copied && (
            <p className="fixed top-[23%] right-[5%] z-10 rounded-md bg-blue-300 p-2">
              Link copied!
            </p>
          )}
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <p className="flex items-center mt-6 gap-2 text-slate-100  text-sm">
            ...
            <div className="flex gap-4">
              ...
              {listing.type === "other" && (
                <p className="bg-yellow-500 w-full max-w-[200px] text-white text-center p-1 rounded-md">
                  For Other
                </p>
              )}
              {listing.offer && (
